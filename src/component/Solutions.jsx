                ...
                <div id="header-carousel" className="carousel slide carousel-fade" data-bs-ride="carousel">
                    <div className="carousel-inner">
                        <div className="carousel-item active">
                            <img className="w-100 vh-100 object-fit-cover" src="https://visme.co/blog/wp-content/uploads/2021/05/how-to-make-a-banner-header-wide.png" alt="Devcorps" style={{visibility:"hidden"}} />
